...
{
    uint8 staticBits = (GPIO_0_DR & (uint8)(~GPIO_0_MASK));
    GPIO_0_DR = staticBits | ((uint8)(value << GPIO_0_SHIFT) & GPIO_0_MASK);
}
...
{
	CyPins_SetPinDriveMode(GPIO_0_0, mode);
}
...
{
    return (GPIO_0_PS & GPIO_0_MASK) >> GPIO_0_SHIFT;
}
...
{
    return (GPIO_0_DR & GPIO_0_MASK) >> GPIO_0_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (GPIO_0_INTSTAT & GPIO_0_MASK) >> GPIO_0_SHIFT;
    }
